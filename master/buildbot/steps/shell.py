...
class ShellCommand(LoggingBuildStep):
    ...
    def describe(self, done=False):
        ...
        try:
            if done and self.descriptionDone is not None:
                return self.render(self.descriptionDone)
            if self.description is not None:
                return self.render(self.description)
    ...
    def setupEnvironment(self, cmd):
        ...
        if slaveEnv:
            ...
            cmd.args['env'] = slef.render(fullSlaveEnv)
    ...
    def start(self):
        ...
        kwargs = self.render(self.remote_kwargs)
        command = self.render(self.command)
...
class SetProperty(ShellCommand):
    ...
    def commandComplete(self, cmd):
        if self.property:
            ...
            propname = self.render(self.property)
...
class WarningCountingShellCommand(ShellCommand):
    ...
    def start(self):
        ...
        args = {
            'slavesrc': self.render(self.suppressionFile),
